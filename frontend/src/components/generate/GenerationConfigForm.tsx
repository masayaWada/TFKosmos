...
export default function GenerationConfigForm({ config, onChange }: GenerationConfigFormProps) {
    ...
    <div style={{ maxWidth: '600px' }}>
      ...
      <div style={{ marginBottom: '1rem' }}>
        ...
        <select
          ...
          onChange={(e) => updateConfig({ import_script_format: e.target.value })}
          style={{
            width: '100%',
            padding: '0.5rem',
            border: '1px solid #ddd',
      ...
      <div style={{ marginBottom: '1rem' }}>
        <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <input
            ...
            onChange={(e) => updateConfig({ generate_readme: e.target.checked })}
          />
          READMEを生成
        </label>
      </div>
