...
**A:** 現在はAWSとAzureに対応しています。GCPサポートは今後の拡張で予定しています（[12-今後の拡張.md](./12-今後の拡張.md) 参照）。
...
詳細は [16-コントリビューションガイド.md](./16-コントリビューションガイド.md) を参照してください。
...
- その他（詳細は [15-トラブルシューティング.md](./15-トラブルシューティング.md) 参照）
...
**A:** [16-コントリビューションガイド.md](./16-コントリビューションガイド.md) を参照してください。特に以下の領域でコントリビューションを歓迎しています：
